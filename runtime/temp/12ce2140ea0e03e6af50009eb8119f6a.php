<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"D:\xampp5\htdocs\wdl\public/../application/index\view\company\store.html";i:1570693756;s:55:"D:\xampp5\htdocs\wdl\application\index\view\layout.html";i:1539243946;}*/ ?>
<!DOCTYPE html>
<html lang="cn">
...
<div class="app-title">
    <div>
        <h1>
            <i class="fa fa-sitemap"></i> 添加组织 </h1>
    </div>
    ...
    <div class="col-md-6">
        <form method="post">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="com_name" id="com_name" placeholder="公司名称">
            </div>
            <div class="form-group">
                ...
                <select class="form-control" name="com_pid">
                    ...
                    <option value="<?php echo $parent['id']; ?>"><?php echo $parent['com_name']; ?></option>
