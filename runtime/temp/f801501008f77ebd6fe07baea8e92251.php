<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"D:\xampp5\htdocs\wdl\public/../application/index\view\record\edit.html";i:1570693545;s:55:"D:\xampp5\htdocs\wdl\application\index\view\layout.html";i:1539243946;}*/ ?>
<!DOCTYPE html>
<html lang="cn">
        ...
        <form role="form" method="POST">
            <div class="form-group has-feedback">
                ...
                <select class="form-control" name="project_subcompany" id="area">
                    ...
                    <option value="<?php echo $com['com_name']; ?>" <?php if($data['project_subcompany']==$com['com_name']): ?> selected <?php endif; ?>><?php echo $com['com_name']; ?></option>
            ...
            <div class="form-group has-feedback">
                ...
                <select class="form-control" id="depart"  name="apply_depart">
                    <option value="<?php echo $data['apply_depart']; ?>"><?php echo $data['apply_depart']; ?></option>
                </select>
                <span class="help-block">选择所属区域后，稍等片刻选择申请部门.</span>
            </div>
            <div class="form-group has-feedback">
                <label for="apply_person">申请人</label>
                <input type="text" class="form-control" id="apply_person" value="<?php echo $data['apply_person']; ?>" name="apply_person" placeholder="请输入申请人">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="customer_manager" value="<?php echo $data['customer_manager']; ?>" name="customer_manager" placeholder="请输入客户经理">
                <span class="help-block">客户方经理姓名</span>
            </div>
            <div class="form-group">
                <label for="project_manager">项目经理</label>
                <input type="text" class="form-control" id="project_manager" value="<?php echo $data['project_manager']; ?>" name="project_manager" placeholder="请输入项目经理">
                <span class="help-block">项目经理姓名</span>
            </div>
            <div class="form-group has-feedback">
                <label for="project_name">项目名称</label>
                <input type="text" class="form-control" id="project_name" value="<?php echo $data['project_name']; ?>" name="project_name" placeholder="请输入项目名称">
                <span class="glyphicon glyphicon-asterisk form-control-feedback" aria-hidden="true"></span>
            ...
            <div class="form-group" id="other_support">
                ...
                <input type="text" name="other" <?php if($data['support_type'] != '性能测试' AND $data['support_type'] != '功能测试' AND $data['support_type'] != '安全测试'): ?>
                value='<?php echo $data['support_type']; ?>' <?php endif; ?> id="other" class="form-control">
                <span class="help-block">其他类型支持时，填写此内容.</span>
            </div>

            <div class="form-group has-feedback">
                <label for="support_person">支持人</label>
                <input type="text" class="form-control" id="support_person" value="<?php echo $data['support_person']; ?>" name="support_person" placeholder="请输入支持人">
                <span class="glyphicon glyphicon-asterisk form-control-feedback" aria-hidden="true"></span>
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="position">
                    <option value="助理测试工程师" <?php if(in_array(($data['position']), explode(',',"助理工程师,助理测试工程师"))): ?>  selected <?php endif; ?>>助理测试工程师</option>
                    <option value="测试工程师" <?php if($data['position']=='测试工程师'): ?> selected <?php endif; ?>>测试工程师</option>
                    <option value="高级测试工程师" <?php if(in_array(($data['position']), explode(',',"高级工程师,高级测试工程师"))): ?> selected <?php endif; ?>>高级测试工程师</option>
                    <option value="部门经理" <?php if(in_array(($data['position']), explode(',',"部门经理,经理"))): ?> selected <?php endif; ?>>部门经理</option>
                    <option value="其他" <?php if(!in_array(($data['position']), explode(',',"助理测试工程师,测试工程师,助理工程师,高级工程师,高级测试工程师,经理,部门经理"))): ?> selected <?php endif; ?>>其他</option>
                </select>
                <span class="help-block">支持人职位</span>
            </div>
            <div class="form-group has-feedback">
                <label for="date_timepicker_start">实际开始时间</label>
                <input id="date_timepicker_start" autocomplete="off" name="start_time" class="form-control" value="<?php echo $data['start_time']; ?>">
                <span class="glyphicon glyphicon-asterisk form-control-feedback" aria-hidden="true"></span>
            ...
            <div class="form-group">
                ...
                <input id="date_timepicker_end" autocomplete="off" name="end_time" class="form-control" value="<?php echo $data['end_time']; ?>">
                <span class="help-block">支持的实际结束时间</span>
            </div>
            <div class="form-group has-feedback">
                <label for="work_time">总工作量(单位:小时)</label>
                <input type="text" class="form-control" name="work_time" value="<?php echo $data['work_time']; ?>" id="work_time" placeholder="请输入工作量">
                <span class="glyphicon glyphicon-asterisk form-control-feedback" aria-hidden="true"></span>
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="status">
                    ...
                    <option value="已完成" <?php if($data['status']=='完成' or $data['status']=='已完成'): ?> selected <?php endif; ?>>已完成</option>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="support_result" name="support_result" placeholder="请输入支持成果描述"><?php echo $data['support_result']; ?></textarea>
                <span class="help-block">简要描述支持过程及结果</span>
            </div>
            <div class="form-group">
                <label for="report_document">相关文档</label>
                <textarea class="form-control" id="report_document" name="report_document" placeholder="请输入相关文档"><?php echo $data['report_document']; ?></textarea>
                <span class="help-block">项目支持输出文档</span>
            </div>
            <div class="form-group">
                <label for="doc_folder">文档存放目录</label>
                <input type="text" class="form-control" id="doc_folder" value="<?php echo $data['doc_folder']; ?>" name="doc_folder" placeholder="请输入文档存放目录">
                <span class="help-block">文档统一放在192.168.105.35上，此处填写文档保存地址，格式：\\192.168.105.35\项目资料（新）\2018\2018-02-11 贵州海云集约化平台性能测试项目</span>
            </div>
            <div class="form-group">
