<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:69:"D:\xampp5\htdocs\wdl\public/../application/index\view\user\store.html";i:1528271069;s:55:"D:\xampp5\htdocs\wdl\application\index\view\layout.html";i:1539243946;}*/ ?>
<!DOCTYPE html>
<html lang="cn">
...
<div class="app-title">
    <div>
        <h1>
            <i class="fa fa-user-circle "></i> 用户管理 </h1>
    </div>
        ...
        <form method="post">
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="department" id="department">
                    <option value="质保一部">质保一部</option>
                    <option value="质保二部">质保二部</option>
                    <option value="质保三部">质保三部</option>
                </select>
            </div>
            <div class="form-group">
                ...
                <div class="radio">
                    <label>
                        <input type="radio" name="isadmin" value="1" checked> 管理员
                    </label>
                </div>
                <div class="radio">
                    <label>
