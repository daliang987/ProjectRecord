<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:67:"D:\xampp5\htdocs\wdl\public/../application/index\view\help\bug.html";i:1528428936;s:55:"D:\xampp5\htdocs\wdl\application\index\view\layout.html";i:1539243946;}*/ ?>
<!DOCTYPE html>
<html lang="cn">
...
<div class="bug-show">
    ...
    <div class="media">
        <div class="media-left media-middle">
            <a href="#">
                <img class="media-object" src="/wdl/public/static/image/header.jpg" width="60" alt="header">
            </a>
        </div>
        <div class="media-body">
            <h4 class="media-heading"><i class="nickname"><?php echo $c['username']; ?></i>&nbsp;&nbsp;&nbsp;
                <small><?php echo date('Y-m-d H:i:s',strtotime($c['datetime'])); ?>
                </small>
            </h4>
            <?php echo $c['comment']; ?><br>
            <?php if($c['uid']==session('userid')): ?><a href="javascript:confirmdel('<?php echo $c['cid']; ?>')" >删除</a><?php endif; ?>
        </div>
    </div>
...
<link rel="stylesheet" type="text/css" href="/wdl/public/static/css/common.css">
<script>
    function confirmdel(id) {
        require(['hdjs'], function (hdjs) {
            hdjs.confirm('确定删除吗?', function () {
                location.href="<?php echo url('index/help/delbug'); ?>"+"?id="+id;
            });
        })
    }
</script> 
