<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:68:"D:\xampp5\htdocs\wdl\public/../application/index\view\user\edit.html";i:1528271004;s:55:"D:\xampp5\htdocs\wdl\application\index\view\layout.html";i:1539243946;}*/ ?>
<!DOCTYPE html>
<html lang="cn">
...
<div class="app-title">
    <div>
        <h1>
            <i class="fa fa-user-circle "></i> 用户修改 </h1>
    </div>
    ...
    <div class="col-md-6">
        <form method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="username" name="username" value="<?php echo $user['username']; ?>" placeholder="用户名">
            </div>
            <div class="form-group">
                <label for="password">密码</label>
                <input type="password" class="form-control" value="<?php echo $user['password']; ?>" name="password" id="password" placeholder="密码">
            </div>
            <div class="form-group">
                <label for="repass">确认密码</label>
                <input type="password" class="form-control" value="<?php echo $user['password']; ?>" name="repass" id="repass" placeholder="确认密码">
            </div>
            <div class="form-group">
                <label for="department">所属部门</label>
                <select name="department" class="form-control" id="department">
                    <option value="质保一部" <?php if($user['department'] == '质保一部'): ?>selected<?php endif; ?>>质保一部</option>
                    <option value="质保二部" <?php if($user['department'] == '质保二部'): ?>selected<?php endif; ?>>质保二部</option>
                    <option value="质保三部" <?php if($user['department'] == '质保三部'): ?>selected<?php endif; ?>>质保三部</option>
                </select>
            </div>
            <div class="form-group">
                <label for="isadmin">是否为管理员</label>
                <div class="radio">
                    <label>
                        <input type="radio" name="isadmin" value="1" <?php if($user['isadmin'] == '1'): ?>checked<?php endif; ?>> 管理员
                    </label>
                </div>
                <div class="radio">
                    <label>
                        <input type="radio" name="isadmin" value="0" <?php if($user['isadmin'] == '0'): ?>checked<?php endif; ?>>非管理员
                    </label>
                </div>
            </div>
