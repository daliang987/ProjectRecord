<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:69:"D:\xampp5\htdocs\wdl\public/../application/index\view\index\pass.html";i:1528441859;s:55:"D:\xampp5\htdocs\wdl\application\index\view\layout.html";i:1539243946;}*/ ?>
<!DOCTYPE html>
<html lang="cn">
...
<div class="app-title">
    <div>
        <h1>
            <i class="fa fa-user-circle "></i> 修改密码 </h1>
    </div>
    ...
    <div class="col-md-6">
        <form method="post">
            ...
            <div class="form-group">
                ...
                <input type="password" class="form-control" name="newpass" id="password" placeholder="新密码">
            </div>
            <div class="form-group">
                <label for="confirmpass">确认新密码</label>
                <input type="password" class="form-control" name="confirmpass" id="confirmpass" placeholder="确认新密码">
            </div>
