<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"D:\xampp5\htdocs\wdl\public/../application/index\view\record\store.html";i:1570693686;s:55:"D:\xampp5\htdocs\wdl\application\index\view\layout.html";i:1539243946;}*/ ?>
<!DOCTYPE html>
<html lang="cn">
    ...
    <div class="col-md-6">
        <form role="form" method="POST">
            ...
            <div class="form-group  has-feedback">
                ...
                <input type="text" class="form-control" id="apply_person" name="apply_person" placeholder="请输入申请人" aria-describedby="apply_person">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="customer_manager" name="customer_manager" placeholder="请输入客户经理" value="/">
                <span class="help-block">客户方经理姓名</span> 
            </div>
            <div class="form-group">
                <label for="project_manager">项目经理</label>
                <input type="text" class="form-control" id="project_manager" name="project_manager" placeholder="请输入项目经理">
                <span class="help-block">项目经理姓名</span> 
            </div>
            <div class="form-group has-feedback">
                <label for="project_name">项目名称</label>
                <input type="text" class="form-control" id="project_name" name="project_name" placeholder="请输入项目名称" aria-describedby="project_name">
                <span class="glyphicon glyphicon-asterisk form-control-feedback" aria-hidden="true"></span>
            ...
            <div class="form-group has-feedback">
                ...
                <input type="text" class="form-control" id="support_person" pattern="^[\u4e00-\u9fa5]{2,4}$" title="只能填写2-4位汉字" name="support_person" placeholder="请输入支持人" aria-describedby="support_person">
                <span class="glyphicon glyphicon-asterisk form-control-feedback" aria-hidden="true"></span>
            ...
            <div class="form-group has-feedback">
                ...
                <input id="date_timepicker_start" autocomplete="off" name="start_time" class="form-control" value="" aria-describedby="date_timepicker_start">
                <span class="glyphicon glyphicon-asterisk form-control-feedback" aria-hidden="true"></span>
            ...
            <div class="form-group has-feedback">
                ...
                <input type="text" class="form-control" name="work_time" id="work_time" placeholder="请输入工作量" aria-describedby="work_time">
                <span class="glyphicon glyphicon-asterisk form-control-feedback" aria-hidden="true"></span>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="support_result" name="support_result" placeholder="请输入支持成果描述"></textarea>
                <span class="help-block">简要描述支持过程及结果</span> 
            </div>
           
            <div class="form-group">
                <label for="report_document">相关文档</label>
                <textarea class="form-control" id="report_document" name="report_document" placeholder="请输入相关文档"></textarea>
