<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"D:\xampp5\htdocs\wdl\public/../application/index\view\record\admintrash.html";i:1539244495;s:55:"D:\xampp5\htdocs\wdl\application\index\view\layout.html";i:1539243946;}*/ ?>
<!DOCTYPE html>
<html lang="cn">
...
<div class="app-title">
    <div>
        <h1>
            <i class="fa fa-dashboard"></i> 删除记录管理 </h1>
    </div>
        ...
        <table class="table table-hover table-condensed table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="btn-group">
                            <a href="javascript:remove(<?php echo $data['id']; ?>)" class="btn btn-primary btn-sm">彻底删除</a>
                        </div>
                    </td>
                </tr>
