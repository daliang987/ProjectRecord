<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"D:\xampp5\htdocs\wdl\public/../application/index\view\company\edit.html";i:1528272332;s:55:"D:\xampp5\htdocs\wdl\application\index\view\layout.html";i:1539243946;}*/ ?>
<!DOCTYPE html>
<html lang="cn">
...
<div class="app-title">
    <div>
        <h1>
            <i class="fa fa-sitemap"></i> 公司修改 </h1>
    </div>
    ...
    <div class="col-md-6">
        <form method="post">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="com_name" value="<?php echo $company['com_name']; ?>" id="com_name" placeholder="公司名称">
            </div>
            <div class="form-group">
                <label for="name">所属父级</label>
                <select class="form-control" name="com_pid">
                    <option value="0">顶级组织</option>
                    <?php if(is_array($_parent) || $_parent instanceof \think\Collection || $_parent instanceof \think\Paginator): $i = 0; $__LIST__ = $_parent;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$parent): $mod = ($i % 2 );++$i;?>
                    <option value="<?php echo $parent['id']; ?>" <?php if($company['com_pid']==$parent['id']): ?>selected<?php endif; ?> ><?php echo $parent['com_name']; ?></option>
